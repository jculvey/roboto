...
LinkExtractor.prototype.extractLinks = function(response, $) {
  ...
  .map( function(href) { return this.normalizeUrl(href, response, !!this.options.allowQueryParams); }, this)
...
LinkExtractor.prototype.normalizeUrl = function(link, response, allowQuery) {
  var href = link.attr('href');
